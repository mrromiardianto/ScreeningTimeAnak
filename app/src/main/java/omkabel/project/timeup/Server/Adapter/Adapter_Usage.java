...
public class Adapter_Usage extends RecyclerView.Adapter<Adapter_Usage.MyViewHolder> implements MyController {
    ...
    @Override
    public Adapter_Usage.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_usage, parent, false);
        Adapter_Usage.MyViewHolder holder = new Adapter_Usage.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(Adapter_Usage.MyViewHolder holder, final int position) {
